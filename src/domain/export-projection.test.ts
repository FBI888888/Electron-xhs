...
describe('legacy-compatible export projection', () => {
  ...
  it('projects legacy headers and split fan profile columns', () => {
    ...
    expect(Object.prototype.hasOwnProperty.call(row, '博主优势')).toBe(true)
    expect(Object.prototype.hasOwnProperty.call(row, '百赞笔记占比')).toBe(true)
    expect(Object.prototype.hasOwnProperty.call(row, '近90天百赞笔记占比')).toBe(true)
    expect(Object.prototype.hasOwnProperty.call(row, '近60日粉丝增量')).toBe(true)
  })
})